...
# cities =  ['Punta Cana', 'Quito', 'Raleigh/Durham', 'Reno', 'Richmond', 'Rochester', 'Sacramento', "Saint George's", 'Saint Martin', 'Salt Lake City',
            # 'San Diego', 'San Francisco', 'San Jose', 'San Jose', 'San Juan', 'Santa Clara', 'Santiago', 'Santo Domingo', 'Sarasota/Bradenton', 'Savannah',
            # 'Seattle', 'St. George', 'Syracuse', 'Tampa', 'Vieux Fort', 'Washington', 'Washington', 'West Palm Beach', 'White Plains', 'Willemstad', 'Worcester']

# def download_airports():
    # airports = csv.reader(open('atc.csv'))
    # for i in airports:
        # keywords.append(i[0])
    # print(keywords)
...
def searchForWord(search_keyword, keywords):
############## Main Program ############
